    ...
    },
    {
      ...
      html:
        ul([
          ...
          `<strong>Where this lives in real code:</strong> the Anthropic and OpenAI SDKs both wrap this function with retries and streaming; LangChain calls it <code>BaseChatModel.invoke</code>; AutoGen calls it <code>ChatCompletionClient.create</code>, and notably has the client itself accumulate usage, which is exactly the design argued for above.`,
        ]),
    },
  ],
